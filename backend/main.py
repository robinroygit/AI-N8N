...
def classify_message(state: State):
    ...
    res=response.choices[0].message.parsed.is_coding_question
    print(">>>",res)
    state["is_coding_question"]=res
    return state
...
def coding_validate_query(state:State):
    ...
    state["accuracy_percentage"]=response.choices[0].message.parsed.accuracy_response
    return state
